...
export const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br ${colorClasses[color]} opacity-10 rounded-full -mr-10 -mt-10`}
      />
...
> = ({ children, title, description, icon: Icon, className = "", onClick }) => {
  return (
    <motion.div
